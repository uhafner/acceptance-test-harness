...
public class AnalysisPluginsTest extends AbstractJUnitTest {
    ...
    public void should_use_default_pattern_xml_is_not_in_workspace_for_checkStyle () {
        ...
        //Validate M und Unbekant fehlermeldung
        ...
        assertThat(build.getConsole()).contains("[ERROR] No files found for pattern '**/checkstyle-result.xml'. Configuration error?\n");
    ...
    public void should_use_default_pattern_xml_is_in_workspace_for_checkStyle () {
        ...
        //Validate M die warnings
        assertThat(build.getConsole()).contains("[CheckStyle] Using default pattern '**/checkstyle-result.xml' since user defined pattern is not set\n");
        assertThat(build.getConsole()).contains("[CheckStyle] Created analysis result for 776 issues (found 0 new issues, fixed 0 issues)\n");
    }

    /** OwnEmpty
     * Test that the specified pattern for checkStyle is used (file is not workspace), if one specified.
     */
    @Test
    public void should_use_specified_pattern_xml_is_not_in_workspace_for_checkStyle () {
        ...
        //Validate M und Unbekant fehlermeldung
        assertThat(build.getConsole()).contains("[CheckStyle] [ERROR] No files found for pattern '**/checkstyle-for-test.xml'. Configuration error?\n");
        assertThat(build.getConsole()).contains("[CheckStyle] Created analysis result for 0 issues (found 0 new issues, fixed 0 issues)\n");
    }

    /** OwnWorkspace
     * Test that the specified pattern for checkStyle is used (file is in workspace), if one specified.
     */
    @Test
