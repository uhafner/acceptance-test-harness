...
public class Mailtrap extends MailService {
    ...
    private String MAILBOX = "909340b9079fe0";
    private String PASSWORD = "d9e897077e33fe";
    private String TOKEN = "5d82f1f117251952f9ef6026da5cff49";
    private String INBOX_ID = "625556";
