...
mvnOptions="-Dsurefire.rerunFailingTestsCount=${RETRY} -Dwebdriver.gecko.driver=${GECKO_DRIVER_PATH} -Dwebdriver.chrome.driver=${CHROME_DRIVER_PATH} -DElasticTime.factor=${ELASTIC}"
